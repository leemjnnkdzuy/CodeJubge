...
class ApiController
{
    ...
    private function saveSubmission($data)
    {
        try {
            ...
            $stmt->execute([
                ...
                $data['language'],
                $data['status'],
                round($data['execution_time'], 0), // Convert to integer for runtime
                round($data['memory_usage'] * 1024 * 1024, 0), // Convert MB to bytes for memory_used
    ...
    // Public method for testing (only for development)
